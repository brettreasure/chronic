...
// Original data without PREM/PROM suffixes (used by home and corporate pages)
export const surveyData: SurveyDataPoint[] = [
  ...
  {
    heading: "97%",
    text: "97% say the program was designed to meet their individual needs",
    hasGraph: true,
    variant: "dark-cyan",
    graph: {
      ...
      data: [
        ...
        { label: "Yes - designed for me", value: 71, color: "#004146" },
      ],
    },
  },
  {
...
export const corporateSurveyData: SurveyDataPoint[] = [
  {
    heading: "84%",
    text: "84% of participants completed the program",
    hasGraph: false,
...
// Profession-specific data with PREM/PROM suffixes (used only by profession page)
export const professionSurveyData: SurveyDataPoint[] = [
  {
    heading: "84%",
    text: "84% of participants completed the program",
    hasGraph: false,
