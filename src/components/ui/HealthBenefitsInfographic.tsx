...
interface HealthBenefitsInfographicProps {
  isVisible: boolean;
}

export function HealthBenefitsInfographic({ isVisible }: HealthBenefitsInfographicProps) {
  const benefits = [
    { 
          ...
          {benefits.map((benefit, index) => (
            <motion.g key={benefit.name}>
              ...
              <motion.circle
                ...
                animate={isVisible ? 
                  benefit.name === "ALIGNS INCENTIVES" ? {
                    // ALIGNS INCENTIVES: Migrate across full infographic width
                    scale: 1,
              ...
              <motion.text
                ...
                animate={isVisible ? 
                  benefit.name === "ALIGNS INCENTIVES" ? {
                    // ALIGNS INCENTIVES: Same migration pattern as circle
                    opacity: 1,
                    x: [0, 80, -60, 100, -80, 70, -90, 0],
                    y: [0, -40, 50, -30, 40, -60, 30, 0]
                  } : {
              ...
              >
                {(() => {
                  ...
                  if (words.length >= 2) {
                    // 2 lines for phrases like "BETTER COST", "REWARDS PREVENTION", etc.
                    return (
                      <>
                        <tspan x={benefit.x} dy="-5">{words[0]} {words[1]}</tspan>
