...
export function ProfessionHeroSection() {
  return (
        ...
        >
          ...
          <div className="max-w-3xl mx-auto space-y-6 text-lg sm:text-xl text-gray-700 dark:text-gray-300 font-body leading-relaxed">
            <p>
              ...
              <br /><br />
              New Australian research on the efficacy of Value-Based Healthcare in exercise physiology. A 12-week program using our 4 Point Medex system. Scroll down to see how this approach drives compliance, adherence, results and loyalty. A breakthrough in the fight against chronic illnesses.
            </p>
          </div>
